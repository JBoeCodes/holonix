...

{
  ...
  home.file = {
    # Global shortcuts configuration - comprehensive to prevent KDE from resetting
    ".config/kglobalshortcutsrc".text = ''
      [ActivityManager]
      _k_friendly_name=Activity Manager
      switch-to-activity-9af66b56-cefc-4295-9f20-23ceab32955a=none,none,Switch to activity "Default"
      ...
      Window Quick Tile Bottom=Meta+Shift+Down,Meta+Shift+Down,Quick Tile Window to the Bottom
      ...
      Window Quick Tile Top=Meta+Shift+Up,Meta+Shift+Up,Quick Tile Window to the Top
      ...
      _launch=none,none,Launch Konsole
      
      [Alacritty]
      _k_friendly_name=Alacritty
      _launch=Meta+Return,none,Launch Alacritty
